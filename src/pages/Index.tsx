      ...
      <section className="container mx-auto px-4 pt-12 pb-8 sm:px-8 sm:pt-16 sm:pb-10">
        <div className="animate-fade-up max-w-3xl">
          ...
          <p className="mt-2 font-body text-base text-muted-foreground leading-relaxed sm:text-lg">
            Систематизированное собрание научных публикаций по&nbsp;основным институтам частного права в&nbsp;периодических изданиях и&nbsp;сборниках статей, составленное Романом Бевзенко
          </p>
        </div>
      </section>
